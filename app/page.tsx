    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        <KPICard
          ...
          description="Kabupaten/Kota covered"
        ...
        <KPICard
          title="Total Store"
          value={kpiData.totalStore}
          description="Alfamidi stores across Sulteng"
          iconSlot={<Store className="w-5 h-5 text-red-600" />}
          iconBg="bg-red-50"
          trend={kpiData.trends.totalStore}
          delay={0.06}
        />
        <KPICard
          title="Active UMKM"
          value={kpiData.activeUMKM}
          description="UMKM partners currently active"
          iconSlot={<Users className="w-5 h-5 text-emerald-600" />}
          iconBg="bg-emerald-50"
          trend={kpiData.trends.activeUMKM}
          delay={0.12}
        />
        <KPICard
          title="Expansion Open"
          value={kpiData.expansionOpen}
          description="Regions with open expansion slots"
          iconSlot={<TrendingUp className="w-5 h-5 text-amber-600" />}
          iconBg="bg-amber-50"
          trend={kpiData.trends.expansionOpen}
          delay={0.18}
        />
      </div>
